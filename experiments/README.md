...
This experimental framework builds directly on:
- **Member 1**: Base CNN-VQC implementation, training/evaluation infrastructure
- **Member 2**: GNN-VQC implementation, graph construction pipeline

Both representations use the same quantum classifier and evaluation harness, ensuring controlled comparison.

## Citation

If you use this experimental framework, please cite the overall project and acknowledge the controlled comparative framework approach for evaluating classical vs graph-based representations in hybrid quantum-classical systems.
